...
<div class="products elements-grid align-items-start woodmart-products-holder <?php echo esc_attr($class); ?> row grid-columns-<?php echo esc_attr(woodmart_loop_prop('products_columns')); ?>"
    data-source="main_loop" data-min_price="<?php echo esc_attr($min_price); ?>"
