                                ...
                                <ul>
                                    <li class="has-extra">
                                        ...
                                        <div class="wrap-quantity-num">
                                            <input class="quantity-num" type="number" min="0" step="1" name="adult"
                                                id="adult" value="1" />
                                    ...
                                    <li class="has-extra">
                                        ...
                                        <div class="wrap-quantity-num">
                                            <input class="quantity-num" type="number" min="0" step="1" max="10"
                                                name="childrent" id="childrent" value="0" />
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="wrap-quantity-num">
                                            <input class="quantity-num" type="number" min="0" step="1" name="kid"
                                                id="kid" value="0" />
                                        </div>
                                    </li>
                                </ul>
