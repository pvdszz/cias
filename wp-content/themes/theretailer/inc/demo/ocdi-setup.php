...
function ocdi_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'inc/demo/theretailer.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'inc/demo/theretailer.widgets.wie',
      'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'inc/demo/theretailer.customizer.dat',
    ),
  );
}
...
function ocdi_plugin_page_setup( $default_settings ) {
  ...
  $default_settings['page_title']  = esc_html__( 'One Click Demo Import' , 'theretailer' );
  $default_settings['menu_title']  = esc_html__( 'Import Demo Data' , 'theretailer' );
