( function( blocks, components, editor, i18n, element ) {
	...
	registerBlockType( 'getbowtied/tr-social-media-profiles', {
		title: i18n.__( 'Social Media Profiles', 'the-retailer-extender' ),
		icon:
			...
			return [
					...
					el(
						...
						el(
							RangeControl,
							{
								...
								min: 10,
								max: 36,
								label: i18n.__( 'Icons Font Size', 'the-retailer-extender' ),
				...
				el(
					...
					el(
						...
						i18n.__('Setup social profile links under Appearance > Customize > Social Media', 'the-retailer-extender' ),
					),
				),
				el(
					ServerSideRender,
